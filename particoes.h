...
o arquivo de dados de entrada, a lista contendo os nomes dos arquivos de saída das partições,
o número de elementos M a ser armazenado em cada partição e o número de registro total do arquivo e o tamanho do reservatório.
...
void atualiza_nome_particaoome(Lista *nomes, int *numeroNomes);
